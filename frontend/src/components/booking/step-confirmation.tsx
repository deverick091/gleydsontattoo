  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-12 space-y-8 h-full">
      ...
      <div>
        ...
        >
          Olá {data.name}, recebemos seu pedido de agendamento. 
      ...
      >
        ...
        <div>
          ...
          <p className="text-white font-bold">{dateFormatted} às {data.time}</p>
        </div>
      </motion.div>
      ...
      >
        <Button asChild size="lg" className="bg-[#25D366] hover:bg-[#20b858] text-white">
          <a href={`https://wa.me/5591999999999?text=${textToShare}`} target="_blank" rel="noopener noreferrer">
